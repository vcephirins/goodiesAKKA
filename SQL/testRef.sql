...
select C.node_identifier "Data Set", A.node_identifier "Reference", D.START_DATE, D.STOP_date
from t_entity C, ta_data_set_data B, t_entity A, t_data_set D
...
and D.data_set_id = B.data_set_id
